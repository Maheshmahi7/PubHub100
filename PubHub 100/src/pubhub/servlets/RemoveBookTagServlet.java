...
public class RemoveBookTagServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Boolean tag = dao.removeTag(book);
		...
		if(isSuccess){
		request.getSession().setAttribute("message", "Book Tag Removed Successfully");
		}
		else
		{
			request.getSession().setAttribute("message", "Entered Book Tag is wrong");
		}
		}
		else{
